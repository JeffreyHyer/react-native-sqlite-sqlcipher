...
package com.reactnativesqlitesqlcipher;
...
@ReactModule(name = SqliteSqlcipherModule.NAME)
public class SqliteSqlcipherModule extends ReactContextBaseJavaModule {

    public static final String TAG = SqliteSqlcipherModule.class.getSimpleName();
    ...
    public SqliteSqlcipherModule(ReactApplicationContext reactContext) {
        super(reactContext);
    ...
    private void executeSqlBatch(String dbname, String[] queries, ReadableArray[] queryParams,
        ...
        for (int i = 0; i < len; i++) {
            ...
            try {
                ...
                errorMessage = ex.getMessage();
                FLog.e(TAG, "SqliteSqlcipherModule.executeSql[Batch](): failed", ex);
            }
